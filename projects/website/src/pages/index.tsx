...
const Home = () => {
  const { trackCalendlyClick, trackButtonClick } = useTrackEvent();

  const openCalendly = () => {
    trackCalendlyClick('homepage-cta');
            ...
            <div className="row justify-content-center">
              <div className="col-12 col-lg-8 text-center">
                ...
                <Link
                  ...
                  onClick={() => trackButtonClick('about-background', 'See the Full Background', 'about')}
                >

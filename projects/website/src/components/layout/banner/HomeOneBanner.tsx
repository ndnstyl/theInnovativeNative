        ...
        <div className="container">
              ...
              <div className="banner__content">
                <h1 className="text-uppercase text-start fw-9 mb-0 title-anim">
                  ...
                  <span className="interval">
                    <i className="icon-arrow-top-right"></i> Systems + AI
                  </span>
                </h1>
              </div>
            </div>
          ...
          <div className="banner__hero-row">
            <div className="banner__hero-text">
              <p>
                20 years of scaling marketing machines across paid acquisition, funnel optimization, and revenue analytics. Now I combine that foundation with AI infrastructure to build systems that grow revenue, reduce CAC, and run without babysitting.
              </p>
              <div className="cta section__content-cta">
                ...
                <div className="single">
                  ...
                  <p className="fw-5">Average ROAS</p>
                </div>
                <div className="single">
                  <h5 className="fw-7">52%</h5>
                  <p className="fw-5">CPA Reduction</p>
                </div>
              </div>
            </div>

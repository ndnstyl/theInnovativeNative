...
const PAGES: NavPage[] = [
  ...
  { label: "Site Prep", href: "/generational-wealth/site-prep" },
  { label: "Foundation", href: "/generational-wealth/foundation" },
  { label: "Storm Shelter", href: "/generational-wealth/storm-shelter" },
  { label: "Electrical", href: "/generational-wealth/electrical" },
  { label: "Finishes", href: "/generational-wealth/finishes" },
  { label: "Insurance", href: "/generational-wealth/insurance" },
  { label: "Being Our Own GC", href: "/generational-wealth/general-contracting" },
  { label: "Permits", href: "/generational-wealth/permits" },

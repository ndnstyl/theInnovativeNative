...
export const valueLadderTiers: ValueLadderTier[] = [
  ...
  },
  {
    ...
    priceRange: "$57 – $197",
    description:
      "Self-deploy AI system blueprints. Step-by-step templates, workflow files, and automation recipes you can run inside your own business.",
    cta: "Get a Blueprint",
    href: "#proof-systems",
    order: 2,
  },
...
export const serviceOfferings: ServiceOffering[] = [
  {
    ...
    capabilities: [
      "Business process mapping to AI workflow design",
      "Data pipeline architecture (structured + unstructured)",
      "AI agent design for research, content, and decision support",
      "Integration planning across your existing tool stack",
      "System documentation your team can actually maintain",
    ],
  ...
  },
  {
    ...
    capabilities: [
      "n8n workflow automation (design, build, deploy)",
      "Airtable and database architecture for operations",
      "AI content engines (generation, scoring, assembly)",
      "Multi-platform distribution automation",
      "Human-in-the-loop guardrails for quality control",
    ],
    icon: "fa-gears",
  },
  {
    ...
    capabilities: [
      "AI readiness audits and gap analysis",
      "Hands-on AI system deployment workshops",
      "Team training on workflow automation tools",
      "Content strategy powered by AI pipelines",
      "Ongoing education through the learning platform",
    ],

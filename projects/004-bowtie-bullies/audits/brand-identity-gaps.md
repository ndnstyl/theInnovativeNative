...
|------|-----------|--------------|-------|
| Headlines | Bangers | Bangers (Anton fallback) | YES |
| Body/Captions | Montserrat | Montserrat (Anton fallback) | YES |
| Data/Stats | Montserrat 600 | Montserrat or Anton | YES |
...
| Item | Severity | Impact |
|------|----------|--------|
| FFMPEG pre-flight checks for Inter Bold and Bebas Neue instead of Bangers and Montserrat | CRITICAL | Pipeline will fail validation or use wrong fonts in production |
...
| Text Font | Bangers, 72-96px | Bangers, 72-96px | YES |
...
| 2 | FFMPEG pre-flight checks wrong fonts (Inter Bold, Bebas Neue) | Blueprint (WF-05) | Replace with Bangers + Montserrat |

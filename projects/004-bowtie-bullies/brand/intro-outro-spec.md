...
MAIN WORDMARK:
  Text: "BOWTIE BULLIES"
  Font: Bangers (Google Fonts) or Anton fallback
  Weight: 700 (Bold)
...
SUBTITLE:
  Text: "THE AFTERMATH"
  Font: Montserrat (Google Fonts) or Anton fallback
  Weight: 400 (Regular)
...
FRAMES 109-120 (4.50s - 5.00s):
  Visual: Subscribe button element fades in below the wordmark.
          ...
          Text inside: "SUBSCRIBE" in Montserrat, 18px, Bone White
...
FRAMES 31-54 (1.00s - 1.80s):
  Visual: "BOWTIE BULLIES" typewriter effect below silhouette.
          ...
          Font: Bangers, 64px, Bone White.
          "THE AFTERMATH" fades in below (Rust Orange, Montserrat, 20px).
  Audio: Faint typewriter sounds (-30dB). Cello sustaining.

FRAMES 55-72 (1.80s - 2.40s):
  Visual: Follow button element fades in:
          "@BowTieBullies" in Montserrat, 20px, Bone White
...
# Fonts: Bangers-Regular.ttf, Montserrat-Regular.ttf
...
ffmpeg -y \
  ...
  -filter_complex "
    ...
    [base]drawtext=fontfile=Bangers-Regular.ttf:
    ...
    drawtext=fontfile=Montserrat-Regular.ttf:
...
ffmpeg -y \
  ...
  -filter_complex "
    ...
    [composed]drawtext=fontfile=Bangers-Regular.ttf:
...
- [ ] **Bangers font file** — Download from Google Fonts (Bangers-Regular.ttf)
- [ ] **Montserrat font file** — Download from Google Fonts (Montserrat-Regular.ttf)

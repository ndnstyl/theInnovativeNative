...
COMPOSITION:
  ...
  Center (all-device safe zone):
    ...
    Right side: "BOWTIE BULLIES" wordmark
                Font: Bangers, UPPERCASE, Bone White (#E7E7E1)
                Size: 80-96px
                Below: "THE AFTERMATH" in Montserrat, lowercase
...
TEMPLATE:
  ...
  Below icon: Category name in Montserrat, 20px, Bone White (#E7E7E1)
...
|------|--------|-----|--------|
| Bangers | Regular (400) | Wordmark, headlines, titles | Google Fonts |
| Montserrat | Regular-Bold (400-700) | Subtitles, labels, body, data | Google Fonts |
| Anton | Regular (400) | Fallback / data (when narrower letterform needed) | Google Fonts |

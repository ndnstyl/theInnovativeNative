...
| 5 | Typography | No fallback font stack specified (web-safe alternatives) | MEDIUM | Web presence, platforms that lack Anton/Space Mono |
...
**What Exists:**
- 3-tier font system (Condensed Sans / Monospaced / Data Mono)
- Specific font recommendations (Anton, Space Mono, JetBrains Mono)
...
|---------|------|------|----------|
| IG Story Text | 40-56px | Anton | IG Stories (1080x1920) |
| IG Story Caption | 28-36px | Space Mono | IG Stories |
| Community Post Header | 48-64px | Anton | YouTube Community |
| Community Post Body | 24-32px | Space Mono | YouTube Community |
| Merch Primary | Scalable vector | Anton | T-shirts, prints |
| Merch Secondary | Scalable vector | Space Mono | Tags, secondary merch text |

#### Gap 2.2: No Fallback Font Stack
**Severity:** MEDIUM
**Impact:** If Anton, Space Mono, or JetBrains Mono are unavailable in a given tool or platform, there is no documented fallback. This leads to ad-hoc substitutions that break visual consistency.

**Recommendation:** Define fallback stacks:
- Anton -> Impact -> Oswald -> Condensed sans-serif system font
- Space Mono -> IBM Plex Mono -> Roboto Mono -> Courier New
- JetBrains Mono -> Fira Code -> Source Code Pro -> monospace system font
...
Or add a small season identifier element: a hairline rule above the text with the season name in 16px Space Mono, Ash Gray. Subtle but present.
...
Frame 72-108 (3.0-4.5s): "BOWTIE BULLIES" types in (typewriter,
    Space Mono). Subscribe button element appears right.
...
- **Stories templates:** Define 3-4 story templates:
  1. Poll template (Dark Steel bg, Rust Orange accent, question in Anton)
  2. News reaction (Screenshot + Tyrone's take in Space Mono)
...
3. **[CRITICAL]** Fix font references in WF-05 (Inter Bold/Bebas Neue -> Anton/Space Mono/JetBrains Mono)
